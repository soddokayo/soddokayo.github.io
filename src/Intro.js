            ...
            <div className="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <div className="font-normal text-gray-700 dark:text-gray-400">
                    <h4 className="ml-10 text-left">
                        ...
                        대체하고 소비자들의 삶에 직접적인 편의를 가져다 줄 수 있는 개발자에 매료되어, 조금 다른 길을 가고자 합니다. <br /> 
                        <br />
                        군에서의 7년은 저에게 많은 가르침을 주었지만, 동시에 사회가 더 효율적으로 개선될 여지가 많다는 것을 깨닫게 해준 시간이기도 합니다. 상당수의 <br />
                        업무가 자동화되지 못해 많은 단순노동인력을 요구하고, 전문가는 부족해 소수의 핵심인력이 유실되면 조직 전체가 흔들리는 일도 비일비재합니다. <br />
                        저는 이를 해결하고자 ADD 근무 중엔 취약점 분석 및 침입탐지 자동화를 연구하고, 사이버작전센터 근무 중엔 보안 업데이트 자동화 스크립트를 개발하는 등 <br />
                        소수의 전문성에 의존하지 않는 조직을 만들도록 노력해 왔습니다. 꾸준히 개발 능력을 보완하여 보다 넓은 사회에 기여하는 사람으로 성장하고 싶습니다. <br />
                    </h4>
